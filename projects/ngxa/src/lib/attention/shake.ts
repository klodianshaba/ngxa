...
interface shakeAnimationConfig extends AnimationConfig{
  translate: string;
}

const shakeAnimation: AnimationReferenceMetadata = animation( animate('{{timings}} {{delay}}', keyframes(shakeKeyframes) ));
